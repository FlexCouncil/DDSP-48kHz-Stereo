...
# Gin config flags.
"""flags.DEFINE_multi_string('gin_search_path', 'models/', 'datasets/',
                          'Additional gin file search paths.')"""
flags.DEFINE_multi_string('gin_search_path', 'models/',
                          'Additional gin file search paths.')
# flags.DEFINE_multi_string('gin_file', [], 'ddsp/training/gin/models/')
