...
class ProcessorGroup(tfkl.Layer):
  ...
  def __init__(self, dag: DAG, name: Text = 'processor_group'):
    ...
    # dag = [(synths.Additive(), ['amps', 'harmonic_distribution', 'f0_hz']), (synths.FilteredNoise(), ['noise_magnitudes']), (Add(), ['filtered_noise/signal', 'additive/signal']), (effects.Reverb(), ['add/signal']),]
    self.dag = dag
